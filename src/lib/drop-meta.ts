...
export const CATEGORY_META: Record<
  string,
  { emoji: string; chip: string; dot: string }
> = {
  Products: {
    emoji: "🛍️",
  ...
  Food: {
    emoji: "🍽️",
    chip: "bg-orange-500/12 text-orange-700 dark:text-orange-300 border-orange-500/25",
    dot: "bg-orange-500",
  },
  Entertainment: {
    emoji: "🎬",
  ...
  Documents: {
    emoji: "📄",
    chip: "bg-slate-500/12 text-slate-700 dark:text-slate-300 border-slate-500/25",
    dot: "bg-slate-500",
  },
  Receipts: {
    emoji: "🧾",
  ...
  Ideas: {
    emoji: "💡",
    chip: "bg-yellow-500/12 text-yellow-700 dark:text-yellow-300 border-yellow-500/25",
    dot: "bg-yellow-500",
  },
  Work: {
    emoji: "💼",
  ...
  Study: {
    emoji: "📚",
    chip: "bg-indigo-500/12 text-indigo-700 dark:text-indigo-300 border-indigo-500/25",
    dot: "bg-indigo-500",
  },
  People: {
    emoji: "👥",
    chip: "bg-pink-500/12 text-pink-700 dark:text-pink-300 border-pink-500/25",
    dot: "bg-pink-500",
  },
  Shopping: {
    emoji: "🛒",
    chip: "bg-lime-500/12 text-lime-700 dark:text-lime-300 border-lime-500/25",
    dot: "bg-lime-500",
  },
  Reservations: {
    emoji: "🔖",
  ...
  Other: {
    emoji: "🗂️",
    chip: "bg-zinc-500/12 text-zinc-600 dark:text-zinc-300 border-zinc-500/25",
    dot: "bg-zinc-500",
  },
};
